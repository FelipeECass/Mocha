create database db_escolagrupo2;
USE db_escolagrupo2;
...
COLLATE latin1_swedish_ci;
ALTER TABLE cidade
  ADD CONSTRAINT cidade_ibfk_1 FOREIGN KEY (fk_est_id)
    REFERENCES estado(est_id);
CREATE TABLE unidade (
  uni_id INT(11) NOT NULL AUTO_INCREMENT,
  uni_nome VARCHAR(30) DEFAULT NULL,
  uni_cidade INT(11) DEFAULT NULL,
  PRIMARY KEY (uni_id)
)
ENGINE = INNODB,
CHARACTER SET latin1,
COLLATE latin1_swedish_ci;
ALTER TABLE unidade
  ADD CONSTRAINT unidade_ibfk_1 FOREIGN KEY (uni_cidade)
    REFERENCES cidade(cid_id);
CREATE TABLE turma (
  tur_matricula INT(11) NOT NULL AUTO_INCREMENT,
  tur_nome VARCHAR(30) DEFAULT NULL,
  tur_unidade INT(11) DEFAULT NULL,
  PRIMARY KEY (tur_matricula)
)
ENGINE = INNODB,
CHARACTER SET latin1,
COLLATE latin1_swedish_ci;
ALTER TABLE turma
  ADD CONSTRAINT turma_ibfk_1 FOREIGN KEY (tur_unidade)
    REFERENCES unidade(uni_id);
CREATE TABLE academico (
  aca_id INT(11) NOT NULL AUTO_INCREMENT,
  aca_nome VARCHAR(30) DEFAULT NULL,
  aca_cpf VARCHAR(11) DEFAULT NULL,
  aca_datanasc DATE DEFAULT NULL,
  aca_sexo ENUM('Masculino','Feminino','Outro') DEFAULT NULL,
  aca_endereco VARCHAR(30) DEFAULT NULL,
  aca_bairro VARCHAR(30) DEFAULT NULL,
  aca_numero VARCHAR(30) DEFAULT NULL,
  aca_complemento VARCHAR(30) DEFAULT NULL,
  aca_telefone VARCHAR(10) DEFAULT NULL,
  aca_celular VARCHAR(11) DEFAULT NULL,
  aca_cep VARCHAR(8) DEFAULT NULL,
  aca_email VARCHAR(30) DEFAULT NULL,
  aca_tipo ENUM('Aluno(a)','Professor(a)','Pedagogo(a)') DEFAULT NULL,
  aca_obs LONGTEXT DEFAULT NULL,
  aca_cidade INT(11) DEFAULT NULL,
  PRIMARY KEY (aca_id)
)
ENGINE = INNODB,
CHARACTER SET latin1,
...
ALTER TABLE academico
  ADD CONSTRAINT academico_ibfk_1 FOREIGN KEY (aca_cidade)
    REFERENCES cidade(cid_id);
        CREATE TABLE falta (
  fal_id INT(11) NOT NULL AUTO_INCREMENT,
  fal_data date DEFAULT NULL,
  fk_aca_id INT(11) DEFAULT NULL,
  PRIMARY KEY (fal_id)
)
ENGINE = INNODB,
CHARACTER SET latin1,
COLLATE latin1_swedish_ci;
ALTER TABLE falta
  ADD CONSTRAINT fal_ibfk_1 FOREIGN KEY (fk_aca_id)
    REFERENCES academico(aca_id);
...
COLLATE latin1_swedish_ci;
ALTER TABLE usuario
  ADD CONSTRAINT usuario_ibfk_1 FOREIGN KEY (fk_aca_id)
    REFERENCES academico(aca_id);
CREATE TABLE materia (
  mat_id INT(11) NOT NULL AUTO_INCREMENT,
  mat_nome VARCHAR(30) DEFAULT NULL,
  PRIMARY KEY (mat_id)
)
ENGINE = INNODB,
CHARACTER SET latin1,
...
CREATE TABLE turma_materia (
  ...
  trm_materia INT(11) DEFAULT NULL,
  trm_matricula INT(11) DEFAULT NULL,
  PRIMARY KEY (trm_id)
)
ENGINE = INNODB,
CHARACTER SET latin1,
...
ALTER TABLE turma_materia
  ADD CONSTRAINT turma_materia_ibfk_1 FOREIGN KEY (trm_materia)
    REFERENCES materia(mat_id);
ALTER TABLE turma_materia
  ADD CONSTRAINT turma_materia_ibfk_2 FOREIGN KEY (trm_matricula)
    REFERENCES turma(tur_matricula);
CREATE TABLE aluno_materia (
  alm_id INT(11) NOT NULL AUTO_INCREMENT,
  alm_nota1 DECIMAL(4, 2) DEFAULT NULL,
  alm_nota2 DECIMAL(4, 2) DEFAULT NULL,
  alm_simulado DECIMAL(4, 2) DEFAULT NULL,
  alm_trab1 DECIMAL(4, 2) DEFAULT NULL,
  alm_avalia DECIMAL(4, 2) DEFAULT NULL,
  alm_academico INT(11) DEFAULT NULL,
  alm_materia INT(11) DEFAULT NULL,
  alm_turma INT(11) DEFAULT NULL,
  PRIMARY KEY (alm_id)
)
ENGINE = INNODB,
CHARACTER SET latin1,
...
ALTER TABLE aluno_materia
  ADD CONSTRAINT aluno_materia_ibfk_1 FOREIGN KEY (alm_academico)
    REFERENCES academico(aca_id);
    ALTER TABLE aluno_materia
  ADD CONSTRAINT aluno_materia_ibfk_2 FOREIGN KEY (alm_materia)
    REFERENCES materia(mat_id);
    ALTER TABLE aluno_materia
  ADD CONSTRAINT aluno_materia_ibfk_3 FOREIGN KEY (alm_turma)
    REFERENCES turma(tur_matricula);
    CREATE TABLE professor_materia (
  pfm_id INT(11) NOT NULL AUTO_INCREMENT,
  pfm_academico INT(11) DEFAULT NULL,
  pfm_materia INT(11) DEFAULT NULL,
  PRIMARY KEY (pfm_id)
)
ENGINE = INNODB,
CHARACTER SET latin1,
...
ALTER TABLE professor_materia
  ADD CONSTRAINT professor_materia_ibfk_1 FOREIGN KEY (pfm_academico)
    REFERENCES academico(aca_id);
ALTER TABLE professor_materia
  ADD CONSTRAINT professor_materia_ibfk_2 FOREIGN KEY (pfm_materia)
    REFERENCES materia(mat_id);
    CREATE TABLE aviso (
  avi_id INT(11) NOT NULL AUTO_INCREMENT,
  avi_texto text DEFAULT NULL,
  avi_mando varchar(50) DEFAULT NULL,
  avi_recebeu varchar(50) DEFAULT NULL,
  PRIMARY KEY (avi_id)
)
ENGINE = INNODB,
CHARACTER SET latin1,
...
INSERT INTO `cidade` (`cid_id`, `cid_nome`, `fk_est_id`) VALUES
(1, 'Afonso Cláudio', 8),
...
-- Inserir matérias:
INSERT INTO `db_escolagrupo2`.`materia` (`mat_id`,`mat_nome`) VALUES 
(1,'Matemática'),
(2,'Português'),
(3,'Literatura'),
(4,'Produção de Texto'),
...
INSERT INTO `db_escolagrupo2`.`academico` (`aca_nome`, `aca_cpf`, `aca_datanasc`, `aca_sexo`, `aca_endereco`, `aca_bairro`, `aca_numero`, `aca_complemento`, `aca_telefone`, `aca_celular`, `aca_cep`, `aca_email`, `aca_tipo`, `aca_obs`) VALUES ('admin', '.', '.', 'Outro', '.', '.', '.', '.', '.', '.', '.', '.', 'Pedagogo(a)', '.');
INSERT INTO `db_escolagrupo2`.`usuario` (`usu_nick`, `usu_senha`, `fk_aca_id`) VALUES ('admin', 'admin', '1');

-- Inserir usuário aluno:
insert into db_escolagrupo2.academico (aca_nome, aca_cpf, aca_datanasc, aca_sexo, aca_endereco, aca_bairro, aca_numero, aca_complemento, aca_telefone, aca_celular, aca_cep, aca_email, aca_tipo, aca_obs, aca_cidade) value ('Gustavo Matheus Renato da Mata','405.231.11320','1965-05-20','Masculino','Alameda Tamoios','Jurunas','502','Ap.405','9127875544','91991370720','66030394','gustavomatheusrenatodamata..gustavomatheusrenatodamata@nacirembalagens.com.br','Aluno(a)','Nenhuma.', 2586);
insert into db_escolagrupo2.usuario (usu_nick, usu_senha, fk_aca_id) value ('20190102', '123', 2);

-- Inserir usuário professor:
insert into db_escolagrupo2.academico (aca_nome, aca_cpf, aca_datanasc, aca_sexo, aca_endereco, aca_bairro, aca_numero, aca_complemento, aca_telefone, aca_celular, aca_cep, aca_email, aca_tipo, aca_obs, aca_cidade) value ('Laís Eduarda Rezende','923.787.07444','1996-07-25','Feminino','1ª Travessa Alto da Bela Vista','Centro','830','Ap.514','8127504082','81985006203','53510431','llaiseduardarezende@achievecidadenova.com.br','Professor(a)','Nenhuma.', '3183');
insert into db_escolagrupo2.usuario (usu_nick, usu_senha, fk_aca_id) value ('20190203', '123', 3);
insert into db_escolagrupo2.professor_materia (pfm_academico, pfm_materia) value (3,4);

-- Inserir Unidade
INSERT INTO `db_escolagrupo2`.`unidade` (`uni_nome`, `uni_cidade`) VALUES ('CEFET-1', '1630');

-- Inserir Turma
INSERT INTO `db_escolagrupo2`.`turma` (`tur_nome`, `tur_unidade`) VALUES ('ELT-1', '1');

-- Inserir aluno_materia_turma:
INSERT INTO `db_escolagrupo2`.`aluno_materia` (`alm_nota1`, `alm_nota2`, `alm_simulado`, `alm_trab1`, `alm_avalia`, `alm_academico`, `alm_materia`, `alm_turma`) VALUES ('0', '0', '0', '0', '0', '2', '4', '1');

-- Inserir turma_materia
INSERT INTO `db_escolagrupo2`.`turma_materia` (`trm_materia`, `trm_matricula`) VALUES ('4', '1');

-- Inserir Aviso:
INSERT INTO `db_escolagrupo2`.`aviso` (`avi_texto`, `avi_mando`, `avi_recebeu`) VALUES ('Teste, Aluno!', 'admin', 'Gustavo Matheus Renato da Mata');
INSERT INTO `db_escolagrupo2`.`aviso` (`avi_texto`, `avi_mando`, `avi_recebeu`) VALUES ('Teste, Professor!', 'Gustavo Matheus Renato da Mata', 'Laís Eduarda Rezende');
INSERT INTO `db_escolagrupo2`.`aviso` (`avi_texto`, `avi_mando`, `avi_recebeu`) VALUES ('Teste, Pedagogo!', 'Gustavo Matheus Renato da Mata', 'Pedagogo(a)');

-- Inserir falta aluno e falta professor:
INSERT INTO `db_escolagrupo2`.`falta` (`fal_data`, `fk_aca_id`) VALUES ('2019-10-25', '2');
INSERT INTO `db_escolagrupo2`.`falta` (`fal_data`, `fk_aca_id`) VALUES ('2019-10-25', '3');